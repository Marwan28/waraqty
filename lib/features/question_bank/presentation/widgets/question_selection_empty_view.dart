...
class QuestionSelectionEmptyView extends StatelessWidget {
  const QuestionSelectionEmptyView({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              QuestionSelectionStrings.emptyTitle,
              textAlign: TextAlign.center,
              style: AppTextStyles.titleMedium,
            ),
            SizedBox(height: AppSpacing.sm.h),
            Text(
              QuestionSelectionStrings.emptySubtitle,
              textAlign: TextAlign.center,
